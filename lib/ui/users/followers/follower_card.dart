...
import 'follower_info_dialog.dart';

class FollowerCard extends StatelessWidget {
  FollowerUsers user;
  FollowerCard({Key? key, required this.user}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GetBuilder<UserController>(builder: (controller) {
      return ListTile(
        ...
        trailing: controller.followingIds.contains(user.pk.toString())
            ? Container(
                height: 30,
