...
Future<Stories?> highlightedStory(
    String userId, String cookie, String reelId) async {
  var dio = Dio();
  ...
  try {
    var response = await dio.get(
        'https://i.instagram.com/api/v1/feed/reels_media/?reel_ids=highlight:$reelId');
    return Stories.fromJson(response.data['reels']['highlight:$reelId']);
  } catch (e) {
    logger.e(e);
    return null;
  }
