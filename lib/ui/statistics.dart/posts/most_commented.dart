...
class MostCommented extends StatelessWidget {
  @override
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(translate('Most Commented Post'),
              ...
              IgnorePointer(
                ...
                child: GetBuilder<UserController>(builder: (controller) {
                  ...
                  controller.postMedias.sort((a, b) => b!
                      ...
                      .compareTo(a!.node!.edgeMediaToComment!.count!));
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "${edge.node!.edgeMediaToComment!.count} ${translate("Comment")}",
                                      style: getRegularStyle(
