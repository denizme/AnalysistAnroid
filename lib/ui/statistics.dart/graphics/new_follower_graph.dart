...
class NewFollowersGraph extends StatefulWidget {
  const NewFollowersGraph({Key? key}) : super(key: key);

  @override
  _NewFollowersGraphState createState() => _NewFollowersGraphState();
}

class _NewFollowersGraphState extends State<NewFollowersGraph> {
                    ...
                    child: Container(
                      ...
                      child: Center(
                        ...
                        style: getMediumStyle(
                            color: day ? Colors.white : ColorManager.primary),
                      )),
                    ),
                  ),
                  InkWell(
  ...
  double getFollowerCount(int day) {
    ...
    double count = Boxes.getFollowers()
        .values
        .toList()
        .where((element) =>
            ...
            !controller.firstFollowersIds.contains(element.pk.toString()))
        .toList()
        .length
        .toDouble();
  ...
  LineChartData dayData() {
    ...
    return LineChartData(
      ...
      lineBarsData: [
        LineChartBarData(
          spots: [
            FlSpot(0, getFollowerCountDay(0, 360)),
            FlSpot(1, getFollowerCountDay(360, 720)),
            FlSpot(2, getFollowerCountDay(720, 1080)),
            FlSpot(3, getFollowerCountDay(1080, 1440)),
          ],
          isCurved: true,
          gradient: LinearGradient(
            colors: gradientColors,
